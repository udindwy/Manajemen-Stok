                    ...
                    <div class="row">
                        <div class="col-xl-6 mb-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="kode_produk" class="form-control bg-light" value="{{ $produk->kode_produk }}" readonly>
                            </div>
                        </div>
                        <div class="col-xl-6 mb-4">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select id="id_supplier" name="id_supplier" class="form-control @error('id_supplier') is-invalid @enderror">
                                    ...
                                    @foreach ($supplier as $item)
                                        <option value="{{ $item->id_supplier }}" {{ old('id_supplier', $produk->id_supplier) == $item->id_supplier ? 'selected' : '' }}>
                                            {{ $item->nama_supplier }}
                                        </option>
                                    @endforeach
                                </select>
