                ...
                <form action="{{ route('produkStore') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-xl-6 mb-3">
                            ...
                            <input type="text" id="kode_produk" class="form-control" value="PRD-{{ str_pad(App\Models\Produk::count() + 1, 4, '0', STR_PAD_LEFT) }}" readonly>
                        </div>
                        <div class="col-xl-6 mb-3">
                    ...
                    <div class="row">
                        <div class="col-xl-6 mb-3">
                            ...
                            <input type="number" id="stok_minimal" name="stok_minimal" class="form-control @error('stok_minimal') is-invalid @enderror" value="{{ old('stok_minimal') }}">
                            @error('stok_minimal')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
